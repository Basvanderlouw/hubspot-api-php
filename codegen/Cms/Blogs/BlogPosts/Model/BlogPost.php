 ...
 * @link     https://openapi-generator.tech
 */
class BlogPost implements ModelInterface, ArrayAccess
{
    ...
    const AB_STATUS_MASTER = 'master';
    const AB_STATUS_VARIANT = 'variant';
    const AB_STATUS_LOSER_VARIANT = 'loser_variant';
    const AB_STATUS_MAB_MASTER = 'mab_master';
    const AB_STATUS_MAB_VARIANT = 'mab_variant';
    const AB_STATUS_AUTOMATED_MASTER = 'automated_master';
    const AB_STATUS_AUTOMATED_VARIANT = 'automated_variant';
    const AB_STATUS_AUTOMATED_LOSER_VARIANT = 'automated_loser_variant';
    ...
    const CURRENT_STATE_AUTOMATED_FOR_FORM = 'AUTOMATED_FOR_FORM';
    const CURRENT_STATE_AUTOMATED_FOR_FORM_BUFFER = 'AUTOMATED_FOR_FORM_BUFFER';
    const CURRENT_STATE_AUTOMATED_FOR_FORM_DRAFT = 'AUTOMATED_FOR_FORM_DRAFT';
    const CURRENT_STATE_AUTOMATED_FOR_FORM_LEGACY = 'AUTOMATED_FOR_FORM_LEGACY';
    const CURRENT_STATE_BLOG_EMAIL_DRAFT = 'BLOG_EMAIL_DRAFT';
    const CURRENT_STATE_BLOG_EMAIL_PUBLISHED = 'BLOG_EMAIL_PUBLISHED';
    const CURRENT_STATE_DRAFT = 'DRAFT';
    const CURRENT_STATE_DRAFT_AB = 'DRAFT_AB';
    const CURRENT_STATE_DRAFT_AB_VARIANT = 'DRAFT_AB_VARIANT';
    const CURRENT_STATE_ERROR = 'ERROR';
    const CURRENT_STATE_LOSER_AB_VARIANT = 'LOSER_AB_VARIANT';
    const CURRENT_STATE_PAGE_STUB = 'PAGE_STUB';
    const CURRENT_STATE_PRE_PROCESSING = 'PRE_PROCESSING';
    const CURRENT_STATE_PROCESSING = 'PROCESSING';
    const CURRENT_STATE_PUBLISHED = 'PUBLISHED';
    const CURRENT_STATE_PUBLISHED_AB = 'PUBLISHED_AB';
    const CURRENT_STATE_PUBLISHED_AB_VARIANT = 'PUBLISHED_AB_VARIANT';
    const CURRENT_STATE_PUBLISHED_OR_SCHEDULED = 'PUBLISHED_OR_SCHEDULED';
    const CURRENT_STATE_RSS_TO_EMAIL_DRAFT = 'RSS_TO_EMAIL_DRAFT';
    const CURRENT_STATE_RSS_TO_EMAIL_PUBLISHED = 'RSS_TO_EMAIL_PUBLISHED';
    const CURRENT_STATE_SCHEDULED = 'SCHEDULED';
    const CURRENT_STATE_SCHEDULED_AB = 'SCHEDULED_AB';
    const CURRENT_STATE_SCHEDULED_OR_PUBLISHED = 'SCHEDULED_OR_PUBLISHED';
    const CURRENT_STATE_AUTOMATED_AB = 'AUTOMATED_AB';
    const CURRENT_STATE_AUTOMATED_AB_VARIANT = 'AUTOMATED_AB_VARIANT';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['content_group_id'] = isset($data['content_group_id']) ? $data['content_group_id'] : null;
        ...
        $this->container['mab_experiment_id'] = isset($data['mab_experiment_id']) ? $data['mab_experiment_id'] : null;
        $this->container['archived'] = isset($data['archived']) ? $data['archived'] : null;
        $this->container['author_name'] = isset($data['author_name']) ? $data['author_name'] : null;
        $this->container['ab_test_id'] = isset($data['ab_test_id']) ? $data['ab_test_id'] : null;
        ...
        $this->container['ab_status'] = isset($data['ab_status']) ? $data['ab_status'] : null;
        $this->container['folder_id'] = isset($data['folder_id']) ? $data['folder_id'] : null;
        $this->container['widget_containers'] = isset($data['widget_containers']) ? $data['widget_containers'] : null;
        ...
        $this->container['page_expiry_date'] = isset($data['page_expiry_date']) ? $data['page_expiry_date'] : null;
        ...
        $this->container['public_access_rules'] = isset($data['public_access_rules']) ? $data['public_access_rules'] : null;
        $this->container['layout_sections'] = isset($data['layout_sections']) ? $data['layout_sections'] : null;
        $this->container['theme_settings_values'] = isset($data['theme_settings_values']) ? $data['theme_settings_values'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ab_status']) && !in_array($this->container['ab_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'ab_status', must be one of '%s'",
        ...
        if (!is_null($this->container['content_type_category']) && !in_array($this->container['content_type_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'content_type_category', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets archived
     *
     * @param bool $archived If True, the post will not show up in your dashboard, although the post could still be live.
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language The explicitly defined language of the Blog Post. If null, the Blog Post will default to the language of the ParentBlog.
     *
     * @return $this
     */
     ...
     *
     * @param string $dynamic_page_hub_db_table_id dynamic_page_hub_db_table_id
     *
     * @return $this
     */
     ...
     *
     * @param bool $page_redirected page_redirected
     *
     * @return $this
     */
     ...
     *
     * @param map[string,\HubSpot\Client\Cms\Blogs\BlogPosts\Model\LayoutSection] $layout_sections layout_sections
     *
     * @return $this
     */
